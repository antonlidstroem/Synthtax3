        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BacklogItems_AspNetUsers_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Language = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false, defaultValue: "sv-SE"),
                    EmailNotifications = table.Column<bool>(type: "bit", nullable: false),
                    ShowMetricsTrend = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BacklogItems_CreatedByUserId",
                table: "BacklogItems",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BacklogItems_Priority",
                table: "BacklogItems",
                column: "Priority");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BacklogItems_TenantId",
                table: "BacklogItems",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_BacklogItems_TenantId_Status",
                table: "BacklogItems",
